...
## Learning-only Start ohne Wallet-Key

Du kannst den Bot ohne `BOT_PRIVATE_KEY` starten, solange `LIVE_TRADING=false` gesetzt ist. Dann läuft er im Lernmodus weiter und beobachtet den Markt, ohne echte Trades zu senden.
